 ...
 */
public class fetch3 extends AsyncTask<Void,Void,Void> {
    ...
    protected Void doInBackground(Void... params) {
        ...
        try {
            URL url = new URL("https://scps.000webhostapp.com/smartcar/read_allprf.php");
...
*/
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        MainActivity2.tv.setText("Your place is occupied by a car having RFID Num:"+rfid);

        MainActivity2.parf=rfid;
